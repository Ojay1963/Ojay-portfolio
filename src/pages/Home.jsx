...
const projects = [
  ...
  {
    title: 'ToolboxHub',
    kicker: 'Search-first utility platform for micro-tools',
    tags: ['Next.js', 'React', 'Tailwind CSS', 'Search UX', 'SEO'],
    role: 'Full Stack Developer',
    timeline: 'Utility and tools platform',
    description: 'A search-first utility platform that turns scattered micro-tools into a structured product users can actually discover and use.',
    problem: 'I built a search-led discovery flow and structured each tool page for SEO so users can reach the right image, PDF, text, calculator, or developer tool in fewer steps.',
    outcome: 'This matters because a large utility catalog only works when it feels organized rather than overwhelming, and when each tool can be found directly from search.',
    highlights: [
      'Search-led discovery flow across a large catalog of utility tools',
      'SEO-structured pages giving each tool targeted search visibility',
      'Scalable frontend architecture for easy browsing and catalog expansion',
    ],
    imageSrc: '/project-previews/toolbox-hub.png',
    imageAlt: 'ToolboxHub site preview',
    demo: 'https://www.toolboxhubapp.com/',
